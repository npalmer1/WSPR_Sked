...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2026 at 03:06 PM
...
(0, 'Windom 80-10m', 'Windom for 80-10m', 2, 0, 0, 0, 0, 0, 0, 0),
(1, 'Cobwebb 20-6m', 'Cobwebb antenna for 20 to 6m', 2, 0, 0, 1, 0, 0, 0, 0);
...
INSERT INTO `frequencies` (`Frequency`, `AudioLevel`, `RXAudioLevel`, `Region`) VALUES
(13.5539, 0, 0, 0);
...
(0, '  1027  Yaesu                  FT-450                  20241118.4      Stable      RIG_MODEL_FT450', 'COM1', '9600', '127.0.0.1', '4532', 0);
...
(1, 'switch1', 'TCP', '5000', '192.168.1.1', '', '', 1, '', 'Arduino (antenna switchable on data pins)'),
(2, 'switch2', 'Serial', 'COM1', '', '9600', '8,none,1,none', 4, '', 'W-410A (antenna selectable by commands)');
...
(0, '0: Speakers (High Definition Audio', 0, '0: Microphone (3- USB Audio Device', 0, 1, 223, 'C:/WSPR_Sked', 0);
...
(0, 'G4GCI', 'G4GCI', 25, 14.0956, 37, 5, '', 'IO90', 0, 'Windom', 0.1, 1, 'C:/WSPR_Sked', 1, 'UTC', 0, 1, '', 0, 0, 0, 0, 0, 0, 'wspr_slots', 0);
...
('IO90', '07-23', '00:00', '00:00'),
('IO90', '07-24', '05:18', '21:02'),
('IO90', '07-25', '05:20', '21:00'),
('IO90', '07-26', '00:00', '00:00'),
...
('IO90', '10-13', '00:00', '00:00'),
('IO90', '10-14', '07:23', '18:16'),
('IO90', '10-15', '07:25', '18:14'),
('IO90', '10-16', '00:00', '00:00'),
